...
describe('CrawlerController', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            ...
            providers: [
                {
                    provide: crawler_service_1.CrawlerService,
                    useValue: mockCrawlerService,
                },
            ],
        }).compile();
        controller = module.get(crawler_controller_1.CrawlerController);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
...
//# sourceMappingURL=crawler.controller.spec.js.map